    ...
    <div className="min-h-[70vh] flex items-center justify-center py-10">
      <div className="w-full max-w-md md:max-w-3xl">
        ...
        <div className="md:grid md:grid-cols-2 md:gap-6 space-y-4 md:space-y-0">
          ...
          <div className="bg-white rounded-xl border border-mist p-6 shadow-sm flex flex-col justify-center">
            ...
            >
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-3 h-11 rounded-lg border border-mist bg-white hover:bg-snow transition-colors text-sm font-medium text-ink"
              >
            ...
            <p className="text-xs text-fog text-center mt-4">
              Only @berkeley.edu accounts are allowed.
            </p>
          </div>
        </div>
      </div>
